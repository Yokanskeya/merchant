    ...
    <div class="container-xxxl">
      <div class="row mt-0 mt-lg-6 justify-content-end">
        <div class="col-12 col-md-8 col-lg-7 col-xl-5 col-xxl-4 mb-4">
          ...
          <h2 class="mb-6">👋 <a href="mailto:yokanskeya@gmail.com" target="blank" class="mouse-md"
                                style="color: #7A4FEE">yokanskeya@gmail.com</a></h2>
          ...
          <p class="mb-5"><strong>Please note that I bill $130 for an initial one-hour session.</strong> This helps me
            to adequately prepare, block off the time, and ensure that the conversation is productive for both of us.
          </p>
          <ActionButton to="https://calendly.com/yokans/discovery" target="_blank">
