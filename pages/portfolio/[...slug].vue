      ...
      <div class="row mt-5 mt-lg-8 mt-xl-7 gx-6 gx-xl-8 pb-3">
        <div class="col-12 col-lg-4 order-2 order-lg-1 pt-6 pt-lg-0">
          <aside class="ps-0 ps-lg-6 mb-5 mb-lg-0" style="position: sticky; top: 60px">
            ...
            <ActionButton to="https://calendly.com/yokans/discovery" target="_blank" data-aos="fade-up">
...
useHead({
  ...
  meta: [
    ...
    { hid: 'og:url', property: 'og:url', content: 'https://yokans.dev/' + route.fullPath },
    ...
    { hid: "twitter:url", name: "twitter:url", content: 'https://yokans.dev/' + route.fullPath },
  ...
  link: [
    { hid: "canonical", rel: "canonical", href: 'https://yokans.dev/' + route.fullPath },
  ],
  bodyAttrs: {
    class: 'enable-scroll'
  }
